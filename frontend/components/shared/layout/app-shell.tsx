...
import { GlobalReportDialog } from "@/components/shared/global/global-report-dialog";
import { getMockTenantList } from "@/lib/mocks/mock-data";
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Don't block rendering - show skeleton in sidebar/navbar areas only
  if (isLoading) {
    console.warn("AppShell: Tenant data loading, rendering with skeleton UI");
  }
